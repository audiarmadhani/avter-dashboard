...
df = pd.read_csv('C:/Users/audia/OneDrive/Documents/Python Scripts/avter-dashboard/.venv/dash_data_new_2.csv')
...
def modellingAudi(origin_airport):
    ...
    #holiday dataset
    df_holiday = pd.read_csv('C:/Users/audia/OneDrive/Documents/Python Scripts/avter-dashboard/.venv/holiday.csv')
    ...
    #import dataframe
    df = pd.read_csv('C:/Users/audia/OneDrive/Documents/Python Scripts/avter-dashboard/.venv/dash_data_new_2.csv', parse_dates=['flown_date'])
    ...
    df_predict = pd.read_csv('C:/Users/audia/OneDrive/Documents/Python Scripts/avter-dashboard/.venv/model_results/{}_predict.csv'.format(origin_airport))
    df_predict['flown_date'] = pd.to_datetime(df_predict['flown_date'])
    df_predict = df_predict.groupby('flown_date', as_index=True).sum()

    df_forecast = pd.read_csv('C:/Users/audia/OneDrive/Documents/Python Scripts/avter-dashboard/.venv/model_results/{}_forecast.csv'.format(origin_airport))
